...
To share a browser session across requests, set a cookie named `session`:

<Session />

The session value can be any unique identifier of up to **255 characters** (regardless of character
