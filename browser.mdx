...
[Chrome DevTools Protocol (CDP) interface](#cdp-control) for assuming navigation yourself that
accepts WebSocket connections at **wss://{apiEndpoint}/browser'.
...
Pages that are retrieved over REST are returned as rendered HTML, raw (unrendered) HTML, or Markdown
