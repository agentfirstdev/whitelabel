...
import { companyName, apiEndpoint } from '/snippets/config.mdx';
...
import Devices from '/snippets/browser/devices.mdx';
import Device from '/snippets/browser/device.mdx';
import Expiration from '/snippets/browser/expiration.mdx';
import Session from '/snippets/browser/session.mdx';
...
retrieval</Link>. Up to **120 seconds** is allotted per real-time API call to accommodate
