...
You can manage costs by mixing REST requests and CDP use. E.g., you may want to prepare a page for
interaction over REST then interact with CDP:

<Accordion icon='terminal' title='View REST-to-CDP sample'>
  <Rest2Cdp />
</Accordion>

The reverse, handing off from CDP to REST, is also doable:
