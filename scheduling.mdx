...
The results or content, if ready, will be returned in the <Link
href='whitelabel/search#response-format'>same format as synchronous results</Link> or <Link
href='whitelabel/browser#response-format'>synchronous content</Link>; otherwise, a JSON status
