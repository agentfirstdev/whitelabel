...
import Search from '/snippets/search/mode.mdx';
import Browser from '/snippets/browser/mode.mdx';
import Results from '/snippets/search/id.mdx';
import Content from '/snippets/browser/id.mdx';
