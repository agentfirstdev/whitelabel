...
These are the scheduling request keys and values:

| Key    | Required | Value                                                                                                    |
| :----- | :------- | :------------------------------------------------------------------------------------------------------- |
| `mode` | ⬜       | The synchronous or asynchronous mode of content retrieval, `sync` or `async`; `sync` is the default mode |
| `id`   | ⬜       | The identifier provided to reference an asynchronous job                                                 |

These are the response keys and values:

| Key      | Value                                                       |
| :------- | :---------------------------------------------------------- |
| `id`     | The identifier that references an asynchronous job          |
