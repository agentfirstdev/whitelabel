...
Because AI calls are long-running, they cost **5 credits** each:

| Service                   | Base credits |
| :------------------------ | :----------- |
| <Link href='ai'>AI</Link> | 5            |

CDP sessions are billed per minute, rounded down to the nearest credit:

| Service                     | Base credits |
| :-------------------------- | :----------- |
| <Link href='cdp'>CDP</Link> | 10/minute    |
...
<Latex>1 base credit x 2 x 2 = 4 total credits</Latex>
