...
**{companyName}'s** search service delivers all popular organic and paid results reliably, as
...
in which case up to **2 minutes** is allocated per API call. <Link href='usage'>Usage data</Link> is
published regularly.
...
| `expiration` | ⬜       | The maximum age of cached results in days to accept, where `0` disables caching; `1` is the default number of days                                                                                                                                                                                                                                                                                               |
