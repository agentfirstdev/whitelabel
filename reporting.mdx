...
| `email`   | ⬜       | **[Whitelabelers only]** The (case-insensitive) email address of the user to select data for; multiple email addresses can be provided by repeating the key; data for all email addresses will be included by default |
| `service` | ⬜       | The service to select data for, `search` or `browser`; multiple services can be provided by repeating the key; data for all services will be included by default                                                      |
